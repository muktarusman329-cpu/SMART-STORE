...
import { Plus, Search, Wallet, PieChart, TrendingDown, Edit, Trash2, Calendar, Tag, X, AlertTriangle } from 'lucide-react';
      ...
      <main className="p-8">
        {error && (
          <div className="flex items-center space-x-3 p-4 mb-6 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-2xl">
            ...
            <button onClick={() => { setError(null); loadExpenses(); }} className="ml-auto text-xs font-bold text-red-600 underline">Retry</button>
          </div>
        )}
        {/* Quick Stats */}
